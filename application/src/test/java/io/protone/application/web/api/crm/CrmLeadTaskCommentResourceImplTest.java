...
public class CrmLeadTaskCommentResourceImplTest {
    ...
    public void createCrmTaskComment() throws Exception {
        ...
        crmLead = crmLeadRepository.saveAndFlush(crmLead.channel(corChannel));
        crmTask = crmTaskRepository.saveAndFlush(crmTask.channel(corChannel).lead(crmLead));
        ...
        restCrmTaskCommentMockMvc.perform(post("/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/lead/{shortName}/task/{taskId}/comment", corOrganization.getShortcut(), corChannel.getShortcut(), crmLead.getShortname(), crmTask.getId())
    ...
    public void getAllCrmTaskComments() throws Exception {
        ...
        restCrmTaskCommentMockMvc.perform(get("/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/lead/{shortName}/task/{taskId}/comment?sort=id,desc", corOrganization.getShortcut(), corChannel.getShortcut(), crmLead.getShortname(), crmTask.getId()))
    ...
    public void getCrmTaskComment() throws Exception {
        ...
        restCrmTaskCommentMockMvc.perform(get("/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/lead/{shortName}/task/{taskId}/comment/{id}", corOrganization.getShortcut(), corChannel.getShortcut(), crmLead.getShortname(), crmTask.getId(), crmTaskComment.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getNonExistingCrmTaskComment() throws Exception {
        // Get the crmTaskComment
        restCrmTaskCommentMockMvc.perform(get("/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/lead/{shortName}/task/{taskId}/comment/{id}", corOrganization.getShortcut(), corChannel.getShortcut(), crmLead.getShortname(), crmTask.getId(), Long.MAX_VALUE))
    ...
    public void updateCrmTaskComment() throws Exception {
        ...
        restCrmTaskCommentMockMvc.perform(put("/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/lead/{shortName}/task/{taskId}/comment", corOrganization.getShortcut(), corChannel.getShortcut(), crmLead.getShortname(), crmTask.getId())
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(crmTaskCommentDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCrmTaskComment() throws Exception {
        ...
        // Get the crmTaskComment
        restCrmTaskCommentMockMvc.perform(delete("/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/lead/{shortName}/task/{taskId}/comment/{id}", corOrganization.getShortcut(), corChannel.getShortcut(), crmLead.getShortname(), crmTask.getId(), crmTaskComment.getId())

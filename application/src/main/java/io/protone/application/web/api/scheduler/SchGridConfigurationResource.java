...
public interface SchGridConfigurationResource {
    ...
    @ApiOperation(value = "getAllSchedulerDefaultGridForChannel", notes = "", response = SchGridThinDTO.class, tags = {"SCHEDULER",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = SchGridThinDTO.class),
    ...
    @ApiOperation(value = "getAllSchedulerGridForGroupedByCategoryChannel", notes = "", response = SchGridThinDTO.class, tags = {"SCHEDULER",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = SchGridThinDTO.class),
            @ApiResponse(code = 401, message = "Unauthorized", response = SchGridThinDTO.class),
            @ApiResponse(code = 403, message = "Forbidden", response = SchGridThinDTO.class),

package io.protone.application.web.rest.dto.crm.thin;
...
public class CrmAccountThinDTO implements Serializable {
    ...
    public CrmAccountThinDTO person(TraCustomerPersonDTO person) {
        this.person = person;
        return this;
    }
    ...
    public CrmAccountThinDTO orders(List<TraOrderDTO> orders) {
        this.orders = orders;
        return this;
    }

    public CrmAccountThinDTO addOrdersItem(TraOrderDTO ordersItem) {
    ...
    public CrmAccountThinDTO paymentDelay(Integer paymentDelay) {
        this.paymentDelay = paymentDelay;
        return this;
    }
    ...
    public CrmAccountThinDTO campains(List<TraCampaignDTO> campains) {
        this.campains = campains;
        return this;
    }

    public CrmAccountThinDTO addCampainsItem(TraCampaignDTO campainsItem) {
    ...
    public CrmAccountThinDTO tasks(List<CrmTaskDTO> tasks) {
        this.tasks = tasks;
        return this;
    }

    public CrmAccountThinDTO addTasksItem(CrmTaskDTO tasksItem) {

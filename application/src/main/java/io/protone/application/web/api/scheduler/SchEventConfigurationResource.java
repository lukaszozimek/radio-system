...
public interface SchEventConfigurationResource {
    ...
    @ApiOperation(value = "getAllSchedulerEventGroupedByCategoryForChannel", notes = "", response = SchEventConfigurationThinDTO.class, tags = {"SCHEDULER",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = SchEventConfigurationThinDTO.class),
            @ApiResponse(code = 401, message = "Unauthorized", response = SchEventConfigurationThinDTO.class),
            @ApiResponse(code = 403, message = "Forbidden", response = SchEventConfigurationThinDTO.class),
    ...
    @RequestMapping(value = "/api/v1/network/{networkShortcut}/channel/{channelShortcut}/scheduler/event/configuration/category/{name}",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<List<SchEventConfigurationThinDTO>> getAllSchedulerEventGroupedByCategoryForChannelUsingGET(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut,
                                                                                                               @ApiParam(value = "channelShortcut", required = true) @PathVariable("channelShortcut") String channelShortcut,

...
public interface CrmOpportunityTaskResource {
    ...
    @RequestMapping(value = "/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/opportunity/{shortName}/task",
    ...
    @RequestMapping(value = "/api/v1/organization/{organizationShortcut}/channel/{channelShortcut}/crm/opportunity/{shortName}/task/{id}",
        produces = {"application/json"},

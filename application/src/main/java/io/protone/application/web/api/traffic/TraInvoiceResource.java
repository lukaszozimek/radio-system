...
public interface TraInvoiceResource {
    ...
    ResponseEntity<List<TraInvoiceDTO>> getAllInvoicesUsingGET(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut,

...
public class CrmCustomerPersonDTO {
    ...
    public CrmCustomerPersonDTO description(String description) {
    ...
    public CrmCustomerPersonDTO firstName(String firstName) {
    ...
    public CrmCustomerPersonDTO id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public CrmCustomerPersonDTO lastName(String lastName) {
    ...
    public CrmCustomerPersonDTO contacts(List<CoreContactDTO> contacts) {
        this.contacts = contacts;
        return this;
    }

    public CrmCustomerPersonDTO addContactsItem(CoreContactDTO contactsItem) {
    ...
    public boolean equals(Object o) {
        ...
        CrmCustomerPersonDTO traCustomerPersonDTO = (CrmCustomerPersonDTO) o;

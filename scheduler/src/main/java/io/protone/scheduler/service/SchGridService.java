...
public class SchGridService {
    ...
    public SchGridDTO saveGrid(SchGrid schGrid) {
        ...
        return findSchGridForNetworkAndChannelAndShortNameDTO(schGrid.getChannel().getOrganization().getShortcut(), schGrid.getChannel().getShortcut(), schGrid.getShortName());
    }
    ...
    public Slice<SchGrid> findSchGridsForNetworkAndChannel(String organizationShortcut, String channelShortcut, Pageable pageable) {
        return schGridRepository.findAllByChannel_Organization_ShortcutAndChannel_ShortcutAndType(organizationShortcut, channelShortcut, SchDiscriminators.GRID_TEMPLATE, pageable);
    }

    @Transactional(readOnly = true)
    public Slice<SchGrid> findAllDefaultGrids(String organizationShortcut, String channelShortcut, Pageable pageable) {
        return schGridRepository.findOneByChannel_Organization_ShortcutAndChannel_ShortcutAndDefaultGridAndType(organizationShortcut, channelShortcut, true, SchDiscriminators.GRID_TEMPLATE, pageable);
    }
    ...
    public Slice<SchGrid> findAllGridsByCategoryNaem(String organizationShortcut, String channelShortcut, String categoryName, Pageable pageable) {
        return schGridRepository.findAllByChannel_Organization_ShortcutAndChannel_ShortcutAndGridCategory_NameAndType(organizationShortcut, channelShortcut, categoryName, SchDiscriminators.GRID_TEMPLATE, pageable);
    }
    ...
    public SchGridDTO findSchGridForNetworkAndChannelAndShortNameDTO(String organizationShortcut, String channelShortcut, String shortName) {
        return schGridMapper.DB2DTO(schGridRepository.findOneByChannel_Organization_ShortcutAndChannel_ShortcutAndShortNameAndType(organizationShortcut, channelShortcut, shortName, SchDiscriminators.GRID_TEMPLATE));
    }
    ...
    public SchGrid findSchGridForNetworkAndChannelAndShortName(String organizationShortcut, String channelShortcut, String shortName) {
        return schGridRepository.findOneByChannel_Organization_ShortcutAndChannel_ShortcutAndShortNameAndType(organizationShortcut, channelShortcut, shortName, SchDiscriminators.GRID_TEMPLATE);
    }
    ...
    public void deleteSchGridByNetworkAndChannelAndShortNAme(String organizationShortcut, String channelShortcut, String shortName) {
        schGridRepository.deleteByChannel_Organization_ShortcutAndChannel_ShortcutAndShortNameAndType(organizationShortcut, channelShortcut, shortName, SchDiscriminators.GRID_TEMPLATE);
    }
    ...
    public SchGrid findOneByorganizationShortcutAndChannelShortcutAndDefaultGridAndDayOfWeek(String organizationShortcut, String channelShortcut, Boolean defaultGrid, CorDayOfWeekEnum corDayOfWeekEnum) {
        return this.schGridRepository.findOneByChannel_Organization_ShortcutAndChannel_ShortcutAndDefaultGridAndDayOfWeekAndType(organizationShortcut, channelShortcut, defaultGrid, corDayOfWeekEnum, SchDiscriminators.GRID_TEMPLATE);
    }
}
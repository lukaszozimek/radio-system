 ...
 */
public class SchColumnNameSeparatorParser implements SchColumnSeparatorParser {
    ...
    public SchEmission parseColumnLog(SchEmission schEmission, List<SchLogColumn> schLogColumnList, SchLogColumn schLogColumn, LocalDate localDate, String logLine, String separator) {
        ...
        if (schEmission.getMediaItem() != null) {
            schEmission.getMediaItem().name(separatedStrings[schLogColumn.getColumnSequence()].trim());
        } else {
            schEmission.mediaItem(new LibMediaItem().name(separatedStrings[schLogColumn.getColumnSequence()].trim()));

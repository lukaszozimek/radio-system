...
public class SchEventEmissionAttachmentDTO extends SchConfigurationTimeParamsDTO {
    ...
    public SchEventEmissionAttachmentDTO mediaItem(LibMediaItemThinDTO mediaItem) {
    ...
    public SchEventEmissionAttachmentDTO fadeStart(Long fadeStart) {
    ...
    public SchEventEmissionAttachmentDTO fadeInLength(Long fadeInLenght) {
    ...
    public SchEventEmissionAttachmentDTO volumeLevel(Long volumeLevel) {
    ...
    public SchEventEmissionAttachmentDTO fadeOutLength(Long fadeOutLength) {
    ...
    public boolean equals(Object o) {
        ...
        SchEventEmissionAttachmentDTO schAttachmentDTO = (SchEventEmissionAttachmentDTO) o;

 ...
 * A Clock.
 */
public class SchClockTemplateThinDTO extends SchTemplateTimeParamsDTO implements Serializable {
    ...
    public SchClockTemplateThinDTO shortName(String shortName) {
        this.shortName = shortName;
        return this;
    }
    ...
    public SchClockTemplateThinDTO name(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        SchClockTemplateThinDTO clock = (SchClockTemplateThinDTO) o;

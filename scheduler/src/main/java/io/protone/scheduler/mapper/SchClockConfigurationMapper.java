 ...
 */
@Mapper(componentModel = "spring", uses = {SchEmissionConfigurationMapper.class, SchConfigurationTimeParamsMapper.class, SchEventMapper.class, CorDictionaryMapper.class, CorUserMapper.class})

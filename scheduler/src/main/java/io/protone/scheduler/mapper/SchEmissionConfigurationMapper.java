 ...
 */
@Mapper(componentModel = "spring", uses = {SchClockConfigurationMapper.class, LibMediaItemThinMapper.class,  SchEventConfigurationMapper.class, SchEventMapper.class, SchAttachmentConfigurationMapper.class})

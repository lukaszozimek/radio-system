...
public interface SchLogColumnConfigurationMapper {
    SchLogColumn DTO2DB(SchLogConfigurationColumnDTO dto, @Context CorChannel corChannel);
    ...
    default List<SchLogColumn> DTOs2DBs(List<SchLogConfigurationColumnDTO> dList, @Context CorChannel corChannel) {
    ...
    @AfterMapping
    default void schLogConfigurationColumnDTOToSchLogColumnAfterMapping(SchLogConfigurationColumnDTO dto, @MappingTarget SchLogColumn entity, @Context CorChannel corChannel) {

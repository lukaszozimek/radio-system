 ...
 */
@Mapper(componentModel = "spring", uses = {SchEmissionConfigurationMapper.class, SchQueueParamsMapper.class, SchTimeParamsMapper.class, CorDictionaryMapper.class, CorUserMapper.class})

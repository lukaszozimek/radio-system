 ...
 */
@Mapper(componentModel = "spring", uses = {SchEmissionConfigurationMapper.class, SchQueueParamsMapper.class, SchConfigurationTimeParamsMapper.class, CorDictionaryMapper.class, CorUserMapper.class})

...
class CONFIGURATIONApi(object):
    ...
    def create_industry_using_post_using_post(self, network_shortcut, industry_dto, **kwargs):
        """
        createIndustry
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_industry_using_post_using_post(network_shortcut, industry_dto, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str network_shortcut: networkShortcut (required)
        :param ConfIndustryPT industry_dto: industryDTO (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_industry_using_post_using_post_with_http_info(network_shortcut, industry_dto, **kwargs)
        else:
            (data) = self.create_industry_using_post_using_post_with_http_info(network_shortcut, industry_dto, **kwargs)
            return data

    def create_industry_using_post_using_post_with_http_info(self, network_shortcut, industry_dto, **kwargs):
        """
        createIndustry
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_industry_using_post_using_post_with_http_info(network_shortcut, industry_dto, callback=callback_function)
        ...
        all_params = ['network_shortcut', 'industry_dto']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_industry_using_post_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `create_industry_using_post_using_post`")
        # verify the required parameter 'industry_dto' is set
        if ('industry_dto' not in params) or (params['industry_dto'] is None):
            raise ValueError("Missing the required parameter `industry_dto` when calling `create_industry_using_post_using_post`")
    ...
    def create_marker_configuration_using_post_using_post(self, network_shortcut, marker_configuration_pt, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_marker_configuration_using_post_using_post(network_shortcut, marker_configuration_pt, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str network_shortcut: networkShortcut (required)
        :param ConfMarkerConfigurationPT marker_configuration_pt: markerConfigurationPT (required)
        :return: ConfMarkerConfigurationPT
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_marker_configuration_using_post_using_post_with_http_info(network_shortcut, marker_configuration_pt, **kwargs)
        else:
            (data) = self.create_marker_configuration_using_post_using_post_with_http_info(network_shortcut, marker_configuration_pt, **kwargs)
            return data

    def create_marker_configuration_using_post_using_post_with_http_info(self, network_shortcut, marker_configuration_pt, **kwargs):
        """
        createMarkerConfiguration
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_marker_configuration_using_post_using_post_with_http_info(network_shortcut, marker_configuration_pt, callback=callback_function)
        ...
        all_params = ['network_shortcut', 'marker_configuration_pt']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_marker_configuration_using_post_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `create_marker_configuration_using_post_using_post`")
        # verify the required parameter 'marker_configuration_pt' is set
        if ('marker_configuration_pt' not in params) or (params['marker_configuration_pt'] is None):
            raise ValueError("Missing the required parameter `marker_configuration_pt` when calling `create_marker_configuration_using_post_using_post`")


        collection_formats = {}

        resource_path = '/api/network/{networkShortcut}/configuration/library/marker'.replace('{format}', 'json')
        path_params = {}
        if 'network_shortcut' in params:
            path_params['networkShortcut'] = params['network_shortcut']
        ...
        body_params = None
        if 'marker_configuration_pt' in params:
            body_params = params['marker_configuration_pt']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ConfMarkerConfigurationPT',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def delete_marker_configuration_using_delete_using_delete(self, network_shortcut, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_marker_configuration_using_delete_using_delete(network_shortcut, id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str network_shortcut: networkShortcut (required)
        :param str id: markerName (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_marker_configuration_using_delete_using_delete_with_http_info(network_shortcut, id, **kwargs)
        else:
            (data) = self.delete_marker_configuration_using_delete_using_delete_with_http_info(network_shortcut, id, **kwargs)
            return data

    def delete_marker_configuration_using_delete_using_delete_with_http_info(self, network_shortcut, id, **kwargs):
        """
        deleteMarkerConfiguration
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_marker_configuration_using_delete_using_delete_with_http_info(network_shortcut, id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_marker_configuration_using_delete_using_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `delete_marker_configuration_using_delete_using_delete`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_marker_configuration_using_delete_using_delete`")


        collection_formats = {}

        resource_path = '/api/network/{networkShortcut}/configuration/library/marker/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'network_shortcut' in params:
            path_params['networkShortcut'] = params['network_shortcut']
        if 'id' in params:
    ...
    def get_all_marker_configuration_using_get_using_get(self, network_shortcut, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_marker_configuration_using_get_using_get(network_shortcut, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_all_marker_configuration_using_get_using_get_with_http_info(network_shortcut, **kwargs)
        else:
            (data) = self.get_all_marker_configuration_using_get_using_get_with_http_info(network_shortcut, **kwargs)
            return data

    def get_all_marker_configuration_using_get_using_get_with_http_info(self, network_shortcut, **kwargs):
        """
        getAllMarkerConfiguration
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_marker_configuration_using_get_using_get_with_http_info(network_shortcut, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_marker_configuration_using_get_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `get_all_marker_configuration_using_get_using_get`")
    ...
    def get_marker_configuration_using_get_using_get(self, network_shortcut, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_marker_configuration_using_get_using_get(network_shortcut, id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_marker_configuration_using_get_using_get_with_http_info(network_shortcut, id, **kwargs)
        else:
            (data) = self.get_marker_configuration_using_get_using_get_with_http_info(network_shortcut, id, **kwargs)
            return data

    def get_marker_configuration_using_get_using_get_with_http_info(self, network_shortcut, id, **kwargs):
        """
        getMarkerConfiguration
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_marker_configuration_using_get_using_get_with_http_info(network_shortcut, id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marker_configuration_using_get_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `get_marker_configuration_using_get_using_get`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_marker_configuration_using_get_using_get`")
    ...
    def update_industry_using_put_using_put(self, network_shortcut, industry_dto, **kwargs):
        """
        updateIndustry
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_industry_using_put_using_put(network_shortcut, industry_dto, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_industry_using_put_using_put_with_http_info(network_shortcut, industry_dto, **kwargs)
        else:
            (data) = self.update_industry_using_put_using_put_with_http_info(network_shortcut, industry_dto, **kwargs)
            return data

    def update_industry_using_put_using_put_with_http_info(self, network_shortcut, industry_dto, **kwargs):
        """
        updateIndustry
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_industry_using_put_using_put_with_http_info(network_shortcut, industry_dto, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_industry_using_put_using_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `update_industry_using_put_using_put`")
        # verify the required parameter 'industry_dto' is set
        if ('industry_dto' not in params) or (params['industry_dto'] is None):
            raise ValueError("Missing the required parameter `industry_dto` when calling `update_industry_using_put_using_put`")
    ...
    def update_marker_configuration_using_put_using_put(self, network_shortcut, marker_configuration_dto, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_marker_configuration_using_put_using_put(network_shortcut, marker_configuration_dto, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str network_shortcut: networkShortcut (required)
        :param ConfMarkerConfigurationPT marker_configuration_dto: markerConfigurationDTO (required)
        :return: ConfMarkerConfigurationPT
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_marker_configuration_using_put_using_put_with_http_info(network_shortcut, marker_configuration_dto, **kwargs)
        else:
            (data) = self.update_marker_configuration_using_put_using_put_with_http_info(network_shortcut, marker_configuration_dto, **kwargs)
            return data

    def update_marker_configuration_using_put_using_put_with_http_info(self, network_shortcut, marker_configuration_dto, **kwargs):
        """
        updateMarkerConfiguration
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_marker_configuration_using_put_using_put_with_http_info(network_shortcut, marker_configuration_dto, callback=callback_function)
        ...
        all_params = ['network_shortcut', 'marker_configuration_dto']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_marker_configuration_using_put_using_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'network_shortcut' is set
        if ('network_shortcut' not in params) or (params['network_shortcut'] is None):
            raise ValueError("Missing the required parameter `network_shortcut` when calling `update_marker_configuration_using_put_using_put`")
        # verify the required parameter 'marker_configuration_dto' is set
        if ('marker_configuration_dto' not in params) or (params['marker_configuration_dto'] is None):
            raise ValueError("Missing the required parameter `marker_configuration_dto` when calling `update_marker_configuration_using_put_using_put`")
        ...
        body_params = None
        if 'marker_configuration_dto' in params:
            body_params = params['marker_configuration_dto']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])

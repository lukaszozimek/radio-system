...
[**delete_industry_using_delete_using_delete**](DICTIONARYApi.md#delete_industry_using_delete_using_delete) | **DELETE** /api/network/{networkShortcut}/configuration/traffic/dictionary/industry/{id} | deleteIndustry
...
[**get_all_size_using_get_using_get**](DICTIONARYApi.md#get_all_size_using_get_using_get) | **GET** /api/network/{networkShortcut}/configuration/network/dictionary/size | getAllSize
...
[**update_person_using_put_using_put**](DICTIONARYApi.md#update_person_using_put_using_put) | **PUT** /api/network/{networkShortcut}/configuration/network/dictionary/people | updatePerson
...
try: 
    # updateCountry
    api_response = api_instance.update_country_using_put_using_put(network_shortcut, conf_country_pt)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_country_using_put_using_put: %s\n" % e)
```
...
# **update_crm_stage_using_put_using_put**
> ConfCrmStagePT update_crm_stage_using_put_using_put(network_shortcut, crm_stage)
...
try: 
    # updateCrmStage
    api_response = api_instance.update_crm_stage_using_put_using_put(network_shortcut, crm_stage)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_crm_stage_using_put_using_put: %s\n" % e)
```
...
# **update_crm_task_status_using_put_using_put**
> ConfCrmTaskStatusPT update_crm_task_status_using_put_using_put(network_shortcut, crm_stage)
...
try: 
    # updateTaskStatus
    api_response = api_instance.update_crm_task_status_using_put_using_put(network_shortcut, crm_stage)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_crm_task_status_using_put_using_put: %s\n" % e)
```
...
# **update_currency_using_put_using_put**
> ConfCurrencyPT update_currency_using_put_using_put(network_shortcut, tax_dto)
...
try: 
    # updateCurrency
    api_response = api_instance.update_currency_using_put_using_put(network_shortcut, tax_dto)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_currency_using_put_using_put: %s\n" % e)
```
...
# **update_invoice_status_using_put_using_put**
> ConfInvoiceStatusPT update_invoice_status_using_put_using_put(network_shortcut, tax_dto)
...
try: 
    # updateInvoiceStatus
    api_response = api_instance.update_invoice_status_using_put_using_put(network_shortcut, tax_dto)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_invoice_status_using_put_using_put: %s\n" % e)
```
...
# **update_lead_source_using_put_using_put**
> ConfLeadSourcePT update_lead_source_using_put_using_put(network_shortcut, lead_source_pt)
...
try: 
    # updateLeadSource
    api_response = api_instance.update_lead_source_using_put_using_put(network_shortcut, lead_source_pt)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_lead_source_using_put_using_put: %s\n" % e)
```
...
# **update_order_status_using_put_using_put**
> ConfTraOrderStatusPT update_order_status_using_put_using_put(network_shortcut, tax_dto)
...
api_instance = swagger_client.DICTIONARYApi()
network_shortcut = 'network_shortcut_example' # str | networkShortcut
tax_dto = swagger_client.ConfTraOrderStatusPT() # ConfTraOrderStatusPT | confTraOrderStatusPT

try: 
    # updateTax
    api_response = api_instance.update_order_status_using_put_using_put(network_shortcut, tax_dto)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_order_status_using_put_using_put: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **network_shortcut** | **str**| networkShortcut | 
 **tax_dto** | [**ConfTraOrderStatusPT**](ConfTraOrderStatusPT.md)| confTraOrderStatusPT | 
...
# **update_person_using_put_using_put**
> ConfPersonPT update_person_using_put_using_put(network_shortcut, person_dto)
...
try: 
    # updatePerson
    api_response = api_instance.update_person_using_put_using_put(network_shortcut, person_dto)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_person_using_put_using_put: %s\n" % e)
```
...
# **update_property_key_using_put_using_put**
> CoreKeyPT update_property_key_using_put_using_put(network_shortcut, property_key_dto)
...
try: 
    # updatePropertyKey
    api_response = api_instance.update_property_key_using_put_using_put(network_shortcut, property_key_dto)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_property_key_using_put_using_put: %s\n" % e)
```
...
# **update_range_using_put_using_put**
> CoreRangePT update_range_using_put_using_put(network_shortcut, core_range_pt)
...
try: 
    # updateRange
    api_response = api_instance.update_range_using_put_using_put(network_shortcut, core_range_pt)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_range_using_put_using_put: %s\n" % e)
```
...
# **update_size_using_put_using_put**
> CoreSizePT update_size_using_put_using_put(network_shortcut, core_size_pt)
...
try: 
    # updateSize
    api_response = api_instance.update_size_using_put_using_put(network_shortcut, core_size_pt)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_size_using_put_using_put: %s\n" % e)
```
...
# **update_tax_using_put_using_put**
> ConfTaxPT update_tax_using_put_using_put(network_shortcut, tax_dto)
...
try: 
    # updateTax
    api_response = api_instance.update_tax_using_put_using_put(network_shortcut, tax_dto)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->update_tax_using_put_using_put: %s\n" % e)
```
...
# **updatelead_status_using_put_using_put**
> ConfLeadStatusPT updatelead_status_using_put_using_put(network_shortcut, lead_status)
...
try: 
    # updateLeadStatus
    api_response = api_instance.updatelead_status_using_put_using_put(network_shortcut, lead_status)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICTIONARYApi->updatelead_status_using_put_using_put: %s\n" % e)
```

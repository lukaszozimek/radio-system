...
public class CrmTaskResourceIntTest {
    ...
    public void setup() {
        MockitoAnnotations.initMocks(this);
            CrmTaskResource crmTaskResource = new CrmTaskResource(crmTaskRepository, crmTaskMapper);
    ...
    public void createCrmTask() throws Exception {
        ...
        restCrmTaskMockMvc.perform(post("/api/crm-tasks")
    ...
    public void getAllCrmTasks() throws Exception {
        ...
        restCrmTaskMockMvc.perform(get("/api/crm-tasks?sort=id,desc"))
    ...
    public void getNonExistingCrmTask() throws Exception {
        // Get the crmTask
        restCrmTaskMockMvc.perform(get("/api/crm-tasks/{id}", Long.MAX_VALUE))
    ...
    public void updateCrmTask() throws Exception {
        ...
        restCrmTaskMockMvc.perform(put("/api/crm-tasks")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(crmTaskDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCrmTask() throws Exception {
        ...
        // Get the crmTask
        restCrmTaskMockMvc.perform(delete("/api/crm-tasks/{id}", crmTask.getId())
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(CrmTask.class);
    }
}

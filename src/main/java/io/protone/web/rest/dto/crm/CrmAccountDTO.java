...
public class CrmAccountDTO implements Serializable {
    ...
    public CrmAccountDTO person(TraCustomerPersonDTO person) {
        this.person = person;
        return this;
    }
    ...
    public CrmAccountDTO tasks(List<CrmTaskDTO> tasks) {
        this.tasks = tasks;
        return this;
    }

    public CrmAccountDTO addTasksItem(CrmTaskDTO tasksItem) {

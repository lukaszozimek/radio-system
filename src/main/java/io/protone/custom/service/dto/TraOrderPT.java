...
public class TraOrderPT   {
  ...
  private SchEmissionPT emission = null;
  ...
  **/
  ...
  public TraOrderPT emission(SchEmissionPT emission) {
  ...
  **/
  @ApiModelProperty(value = "")
  public SchEmissionPT getEmission() {
    return emission;
  }

  public void setEmission(SchEmissionPT emission) {
    this.emission = emission;
  }

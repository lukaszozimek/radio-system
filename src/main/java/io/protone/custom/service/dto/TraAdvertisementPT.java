...
public class TraAdvertisementPT {
    ...
    public TraAdvertisementPT mediaItemId(LibMediaItemPT mediaItemId) {
     ...
     **/
    @ApiModelProperty(value = "")
    public LibMediaItemPT getMediaItemId() {
        return mediaItemId;
    }

    public void setMediaItemId(LibMediaItemPT mediaItemId) {
        this.mediaItemId = mediaItemId;
    }

...
public class LibItemPT   {
  ...
  @JsonProperty("author")
  private LibPersonPT author = null;

  @JsonProperty("composer")
  private LibPersonPT composer = null;
  ...
  **/
  ...
  public LibItemPT author(LibPersonPT author) {
    this.author = author;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public LibPersonPT getAuthor() {
    return author;
  }

  public void setAuthor(LibPersonPT author) {
    this.author = author;
  }

  public LibItemPT composer(LibPersonPT composer) {
  ...
  **/
  @ApiModelProperty(value = "")
  public LibPersonPT getComposer() {
    return composer;
  }

  public void setComposer(LibPersonPT composer) {
    this.composer = composer;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.album, libItemPT.album) &&
        ...
        Objects.equals(this.author, libItemPT.author) &&
        Objects.equals(this.composer, libItemPT.composer) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(album, artist, author, composer, idx, label, length, library, markers, name, properties, resourceType, state, stream, tags, track);
  }

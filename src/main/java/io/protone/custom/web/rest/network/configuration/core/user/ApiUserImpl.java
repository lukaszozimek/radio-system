...
public class ApiUserImpl implements ApiUser {
    ...
    private final Logger log = LoggerFactory.getLogger(io.protone.web.rest.UserResource.class);
    ...
    public ApiUserImpl(CustomCorUserRepository userRepository, CustomMailService mailService,
    ...
    @Override
    public ResponseEntity<CoreKeyPT> getUserUsingGET(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut, @ApiParam(value = "id", required = true)@PathVariable String login) {
        return null;
    }

    @Override
    public ResponseEntity<Void> deleteUserUsingDELETE(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut, @ApiParam(value = "id", required = true) @PathVariable String login) {
        return null;
    }

    @Override
    public ResponseEntity<List<CoreKeyPT>> getAllUsersUsingGET(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut) {
        return null;
    }

    @Override
    public ResponseEntity<CoreKeyPT> updateUserUsingPUT(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut, @ApiParam(value = "propertyKeyDTO", required = true)@RequestBody CoreUserPT managedUserVM) {
        return null;
    }

    @Override
    public ResponseEntity<CoreKeyPT> createUserUsingPOST(@ApiParam(value = "networkShortcut", required = true) @PathVariable("networkShortcut") String networkShortcut, @ApiParam(value = "propertyKeyDTO", required = true) @RequestBody CoreUserPT managedUserVM) {
        return null;
    }
}

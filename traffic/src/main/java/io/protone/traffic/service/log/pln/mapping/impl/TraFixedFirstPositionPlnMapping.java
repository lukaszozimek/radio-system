 ...
 */
@Service("traFixedFirstPositionPlnMapping")
@Qualifier("traFixedFirstPositionPlnMapping")
public class TraFixedFirstPositionPlnMapping implements TraPlnMapping {
    private final Object lockObject = new Object();
    private final Logger log = LoggerFactory.getLogger(TraFixedFirstPositionPlnMapping.class);
    ...
    public TraLogDiff mapToEntityPlaylist(List<TraPlaylist> entiyPlaylists, List<TraLogEmission> parsedEmissions, LibMediaItem libMediaItem) {
        ...
        return new TraLogDiff(entiyPlaylists, parsedEmissions);
    }
